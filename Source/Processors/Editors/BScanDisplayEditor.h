...
#ifndef __BSCANDISPLAYEDITOR_H_A2812B0D__
...
class BScanDisplayEditor : public VisualizerEditor
{
public:
	BScanDisplayEditor(GenericProcessor*, bool useDefaultParameterEditors);
	~BScanDisplayEditor();
...
#endif  // __BSCANDISPLAYEDITOR_H_A2812B0D__
